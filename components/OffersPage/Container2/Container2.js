    ...
    return (
        <div className='main-div py-[100px]'>
            ...
            <div className='flex gap-[30px]'>
                ...
                {/* region */}
                <Listbox as="div" className="relative max-w-[250px] w-full" value={selectedRegion} onChange={setSelectedRegion}>
                    {({ open }) => (
                        <>
                            ...
                            >
                                <Listbox.Options className="absolute border p-1 rounded shadow w-full bg-white">
                ...
                {/* sort by rating */}
                <Listbox as="div" className="relative max-w-[130px] w-full" value={sortingByRating} onChange={setSortingByRating}>
                    {({ open }) => (
                        <>
                            <Listbox.Button className="border flex justify-between items-center gap-4 p-1 w-full rounded group">
            ...
            <div className='py-[50px] flex flex-col gap-12'>
                ...
                <div className='flex gap-8'>
                    <div className='max-w-[350px] w-full aspect-[7/6] relative shadow-md'>
                        <Image src="https://preview.colorlib.com/theme/travelix/images/xoffer_6.jpg.pagespeed.ic.z1jAmiqjUy.webp" layout='fill' objectFit='cover' alt="img" />
                        <div className='absolute bg-orange bottom-8 text-[18px] text-white font-semibold px-4'>RADDISSON BLU</div>
                    </div>
                    <div className='flex flex-col'>
                        ...
                        <button className='text-[14px] font-[700] text-white p-4 bg-[#31124b] transition-all hover:shadow hover:shadow-[#31124b] px-[46px] lg:self-start mt-auto rounded-[100vmax]'>BOOK...</button>
                    </div>
                </div>
