...
const Container2 = () => {
  ...
  //   );
  //   const Daria = () => <div>Daria</div>;

  //   const data = [<Photo />, <Daria />];
  //   return data[openTab];
  // }, [openTab, openAccordion, language]);
  ...
  return (
    <div className="main-div grid grid-cols-1 ml:grid-cols-1 py-[100px] ml:py-[20px] gap-[20px]">
      {/* left */}

      <div className="main-div grid grid-cols-1 ml:grid-cols-1 py-[100px] ml:py-[20px] gap-[20px]">
        {" "}
        <div className="col-span-2 space-y-12 ">
          <h1 className="ml:text-[20px]">{nameLang(tours, language)}</h1>
          ...
          <div className="flex flex-col gap-2 ml:w-full">
            ...
            <div>
              <h3 className="text-black font-semibold ml:text-[20px]">
              ...
              <div className="prices">
                ...
                <div className="price_card flex bg-slate-100 p-2 rounded text-black justify-between mb-3">
                  ...
                  <p>${(tours?.price * 60) / 100}</p>
                  <a>${tours?.price}</a>
                </div>
                <div className="price_card flex bg-slate-100 p-2 rounded text-black justify-between mb-3">
                  <p>2 {language["person"]}</p>
                  <p>${(tours?.price * 50) / 100}</p>
                  <a>${(tours?.price * 60) / 100}</a>
                </div>
                <div className="price_card flex bg-slate-100 p-2 rounded text-black justify-between mb-3">
                  <p>3 {language["person"]}</p>
                  <a>${(tours?.price * 50) / 100}</a>
      ...
      {/* <div className="container mx-auto">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="p-3 mt-6 bg-white border">{tabs}</div>
        </div>
      </div> */}
