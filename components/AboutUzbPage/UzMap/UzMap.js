...
const UzMap = () => {
    ...
    return (
        <div className='main-div py-[50px]'>
            <h1 className='mb-4'><span className='text-orange'>Cities of </span>  Uzbekistan</h1>
            <div className='map-container'>


                <motion.span variants={variants} animate={cursor} className='  bg-white/50 border-slate-600 transform  border rounded-lg backdrop-blur-sm p-4 absolute top-0 left-0 font-bold text-[#4255A4] text-xs' >{label}</motion.span>


                <svg className='svg-map' mapsvg="http://mapsvg.com" dc="http://purl.org/dc/elements/1.1/"
                    rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" svg="http://www.w3.org/2000/svg"
                    xmlns="http://www.w3.org/2000/svg" geoViewBox="55.997099 45.594337 73.133286 37.176101"
                    ...
                    <motion.path
                        ...
                        onMouseEnter={() => showLabelHandler("Aral Sea")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/aral-sea")}
                        ...
                        className="cls-5 water mapsvg-region mapsvg-disabled mapsvg-disabled" title="Aral Sea" id="UZ-AS"></motion.path>
                    <motion.path
                        initial={{
                            pathLength: 0,
                        }}
                        ...
                        onMouseEnter={() => showLabelHandler("Sarvan (Sughd Province, Tajikistan)")} onMouseLeave={hideLabelHandler}
                        ...
                        title="Sarvan (Sughd Province, Tajikistan)" id="TJ-SU" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Andijan")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/andijan")}
                        ...
                        title="Andijon" id="UZ-AN" className=" mapsvg-region cls-5"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Bukhara")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/bukhara")}
                        ...
                        title="Buxoro" id="UZ-BU" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Fergana")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/fergana")}
                        ...
                        title="Farg‘ona" id="UZ-FA" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Jizzakh")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/jizzakh")}
                        ...
                        title="Jizzax" id="UZ-JI" className="cls-5 mapsvg-region"
                    >
                    </motion.path>

                    {/* <a title="Namangan" href=""> */}
                    <motion.path
                        initial={{
                            pathLength: 0,
                        }}
                        ...
                        onMouseEnter={() => showLabelHandler("Namangan")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/namangan")}
                        ...
                        title="Namangan" id="UZ-NG" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    {/* </a> */}
                    ...
                    <motion.path
                        ...
                        onMouseEnter={() => showLabelHandler("Navoiy")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/navoi")}
                        ...
                        title="Navoiy" id="UZ-NW" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Qashqadaryo")} onMouseLeave={hideLabelHandler}
                        ...
                        title="Qashqadaryo" id="UZ-QA" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Qoraqalpog‘iston Respublikasi")} onMouseLeave={hideLabelHandler}
                        ...
                        title="Qoraqalpog‘iston Respublikasi" id="UZ-QR" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Samarkand")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/samarkand")}
                        ...
                        title="Samarqand" id="UZ-SA" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Sirdaryo")} onMouseLeave={hideLabelHandler}
                        ...
                        title="Sirdaryo" id="UZ-SI" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Surxondaryo")} onMouseLeave={hideLabelHandler}
                        ...
                        title="Surxondaryo" id="UZ-SU" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Tashkent City")} onMouseLeave={hideLabelHandler}
                        ...
                        title="Toshkent City" id="UZ-TK" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Tashkent")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/tashkent")}
                        ...
                        title="Toshkent" id="UZ-TO" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                    <motion.path
                        initial={{
                        ...
                        onMouseEnter={() => showLabelHandler("Khiva")} onMouseLeave={hideLabelHandler} onClick = {() => router.push("/about-uzbekistan/khiva")}
                        ...
                        title="Xorazm" id="UZ-XO" className="cls-5 mapsvg-region"
                    >
                    </motion.path>
                </svg>
