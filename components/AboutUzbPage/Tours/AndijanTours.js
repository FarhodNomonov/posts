        ...
        <>
            <div className='absolute w-full top-0 h-[55vh] flex justify-center items-center'>
                ...
                <div className='absolute z-[1] inset-0 bg-lightPurple text-center pt-20 grid content-center text-white'>
                    ...
                    <h1 className="text-white font-beyond text-[40px] xs:text-[70px] sm:text-[100px] leading-[1.5] -mt-12">Andijan</h1>
                </div>
            </div>

            <div className='main-div grid grid-cols-4 gap-[30px] py-[50px] mt-[40vh]'>
                <div className='col-span-3 space-y-4'>
                    <h1 className='text-orange'>Andijan Tours</h1>
                    <h3 className='text-black'>Group Tours and Private Andijan Trips</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, eos? Aut accusantium veniam velit eius deleniti delectus aperiam minus tempora, provident ipsam, molestiae, placeat optio maiores qui corrupti. Itaque, numquam. Voluptatibus, nam ratione provident rem dolores tenetur voluptates dicta, officiis possimus est sint qui illo repellendus corrupti architecto esse et.</p>
                    ...
                    <div className='py-[50px] flex flex-col gap-12'>
                        ...
                        <div className='flex gap-8 items-start'>
                            <div className='w-[300px] shrink-0 aspect-[8/9] relative shadow-md'>
                                ...
                                <div className='absolute bg-orange bottom-8 text-[18px] text-white font-semibold px-4 w-[80%]'>Andijan City Tour</div>
                            </div>
                        ...
                        <div className='flex gap-8'>
                            <div className='w-[300px] shrink-0 aspect-[8/9] relative shadow-md'>
                                ...
                                <div className='absolute bg-orange bottom-8 text-[18px] text-white font-semibold px-4 w-[80%]'>2-day Tour to Andijan from Tashkent</div>
                            </div>
                            <div className='flex flex-col'>
                                <div className='flex justify-between items-center'>
                                    <div className='flex items-end gap-3'>
