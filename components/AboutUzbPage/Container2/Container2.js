            ...
            <div className='relative flex items-cente h-[95vh]'>
                ...
                <Tab.Group as="div" className="relative h-full flex flex-col w-1/2 p-[50px]">
                    ...
                    <Tab.Panels className="mt-2 flex-1 overflow-y-scroll overscroll-contain border-black/20 border rounded-xl">
                        ...
                        >
                            <h3 className='text-[16px] text-slate-900 font-semibold p-3'>About Uzbekistan</h3>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    <span>Area:</span>
                                    <span className=" text-sm font-normal leading-4 text-gray-500">448.9 thousand square kilometers.</span>
                                </h3>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    ...
                                    <span className=" text-sm font-normal leading-4 text-gray-500">More than 32 million people</span>
                                </h3>
                                <span className={classNames('absolute inset-0 rounded-md', 'ring-blue-400 focus:z-10 focus:outline-none focus:ring-2')} />
                            </div>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    <span>Capital:</span>
                                    <span className=" text-sm font-normal leading-4 text-gray-500">Tashkent</span>
                                </h3>
                                <span className={classNames('absolute inset-0 rounded-md', 'ring-blue-400 focus:z-10 focus:outline-none focus:ring-2')} />
                            </div>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    <span>Currency:</span>
                                    <span className=" text-sm font-normal leading-4 text-gray-500">Sum</span>
                                </h3>
                                <span className={classNames('absolute inset-0 rounded-md', 'ring-blue-400 focus:z-10 focus:outline-none focus:ring-2')} />
                            </div>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    ...
                                    <span className=" text-sm font-normal leading-4 text-gray-500"> 12 regions and the Autonomous Republic of Karakalpakstan.</span>
                                </h3>
                                <span className={classNames('absolute inset-0 rounded-md', 'ring-blue-400 focus:z-10 focus:outline-none focus:ring-2')} />
                            </div>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    ...
                                    <span className=" text-sm font-normal leading-4 text-gray-500"> Samarkand, Bukhara, Khiva, Fergana, Andijan, Urgench, Navoiy, Namangan, Nukus, Termez, Karshi.</span>
                                </h3>
                                <span className={classNames('absolute inset-0 rounded-md', 'ring-blue-400 focus:z-10 focus:outline-none focus:ring-2')} />
                            </div>
                            ...
                            <div className="relative rounded-md p-3 hover:bg-gray-100" >
                                <h3 className="text-sm font-medium leading-5 text-slate-900 space-x-3">
                                    ...
                                    <span className=" text-sm font-normal leading-4 text-gray-500"> Uzbek</span>
                                </h3>
